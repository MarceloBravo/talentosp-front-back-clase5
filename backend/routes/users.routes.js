...
module.exports = (app) => {
    ...
    app.post('/api/users', authenticateToken, validaDatosUsuario, parseUserData, (req, res, next) => userController.createUser(req, res, next));
    app.post('/api/register', validaDatosUsuario, parseUserData, (req, res, next) => userController.createUser(req, res, next));
    app.put('/api/users/:id', authenticateToken, validaDatosUsuario, parseUserData, (req, res, next) => userController.updateUser(req, res, next));
